...
$file2 = Chris_INSTALL_PATH . $classFile;
if(is_file($file1)) {
require_once($file1);
...
function exceptionHandler($e) {
  echo "Chris: Uncaught exception: <p>" . $e->getMessage() . "</p><pre>" . $e->getTraceAsString(), "</pre>";
}
...
function htmlent($str, $flags = ENT_COMPAT) {
  return htmlentities($str, $flags, CChris::Instance()->config['character_encoding']);
}
...
* OnChris the two biggest parts are used.
*
