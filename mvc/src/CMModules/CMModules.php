<?php
/**
* A model for managing Chris modules.
*
* @package ChrisCore
*/
...
* Properties
*/
  private $ChrisCoreModules = array('CChris', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $ChrisCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
...
*/
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isChrisCore'] = in_array($rc->name, $this->ChrisCoreModules);
      $details['isChrisCMF'] = in_array($rc->name, $this->ChrisCMFModules);
