...
*/
$Chris->config['debug']['Chrisdia'] = false;
$Chris->config['debug']['session'] = false;
$Chris->config['debug']['timer'] = true;
$Chris->config['debug']['db-num-queries'] = true;
$Chris->config['debug']['db-queries'] = true;


/**
* Set database(s).
*/
$Chris->config['database'][0]['dsn'] = 'sqlite:' . Chris_SITE_PATH . '/data/.ht.sqlite';
...
*/
$Chris->config['url_type'] = 1;


/**
* Set a base_url to use another than the default calculated
*/
$Chris->config['base_url'] = null;


/**
* How to hash password of new users, choose from: plain, md5salt, md5, sha1salt, sha1.
*/
$Chris->config['hashing_algorithm'] = 'sha1salt';


/**
* Allow or disallow creation of new user accounts.
*/
$Chris->config['create_new_users'] = true;


/**
* Define session name
*/
$Chris->config['session_name'] = preg_replace('/[:\.\/-_]/', '', __DIR__);
$Chris->config['session_key'] = 'Chrisdia';


/**
* Define default server timezone when displaying date and times to the user. All internals are still UTC.
*/
$Chris->config['timezone'] = 'Europe/Stockholm';


/**
* Define internal character encoding
*/
$Chris->config['character_encoding'] = 'UTF-8';


/**
* Define language
*/
$Chris->config['language'] = 'en';
...
*/
$Chris->config['controllers'] = array(
...
* Define menus.
*
* Create hardcoded menus and map them to a theme region through $Chris->config['theme'].
*/
$Chris->config['menus'] = array(
  'navbar' => array(
  ...
  'my-navbar' => array(
    'home' => array('label'=>'About Me', 'url'=>'http://www.student.bth.se/~chro13/phpmvc/kmom06/me/index.php'),
...
* Template files can reside in the parent or current theme, the CChris::ThemeEngineRender()
...
*
* path: Path to current theme, relativChris Chris_INSTALL_PATH, for example themes/grid or site/themes/mytheme.
